...
| Category | Role / Component | Technologies & Tools |
| :--- | :--- | :--- |
| **Frontend** | Framework | [React 18](https://react.dev/) + [TypeScript](https://www.typescriptlang.org/) |
| | Build Tool | [Vite](https://vitejs.dev/) |
| | UI Primitives & Icons | [Radix UI Slot](https://www.radix-ui.com/), [Lucide React Icons](https://lucide.dev/) |
...
| **Backend & Database** | BaaS / Database | [Supabase](https://supabase.com/) (`@supabase/supabase-js`) |
| | Database Driver | [PostgreSQL](https://www.postgresql.org/) (`pg`) |
| **Doc Processing & ML** | PDF Parsing | [PDF.js](https://mozilla.github.io/pdf.js/) (`pdfjs-dist`) |
...
| **Development & Quality** | Code Quality | ESLint 9 + TypeScript-ESLint |
